...
import p from "../images/prohostlogo2.png";
import sms from "../images/gatewaylogo2.png";
import promo from "../images/promologo2.png";
          ...
          <div className="about-us-screen">
            ...
            <div className="middle">
              ...
              <div className="who-1">
                <h3>
                  {" "}
                  We are a Saudi institution based in Jeddah specialized in
                  information technology, and it employs distinguished national
                  cadres and international experts of different nationalities.
                  We work on producing professional projects and unlimited
                  support services.
                </h3>
              </div>
              ...
              <div className="who-1">
                <h3>
                  {" "}
                  Here in PureCode we put the customer needs first. Our mission
                  is to help customers unlock their creatvity and build
                  exceptional content by our help with the best quality &amp;
                  reasonable prices.
                </h3>
              </div>
              ...
              <div className="vision-1">
                <h3>
                  {" "}
                  Be a major company on the middle east at business solutions.
                  Also, leader in Web design and programming solutions and
                  systems.
                </h3>
              </div>
